...
function randomHead () {
  ...
  ————————————————
  版权声明：本文为CSDN博主「哀木i」的原创文章，遵循CC 4.0 BY - SA版权协议，转载请附上原文出处链接及本声明。
  原文链接：https://blog.csdn.net/qq_41569151/article/details/102868147
...
module.exports = async (params = {}) => {
  ...
  const res = await axios.post(
    ...
    { headers: { 'User-Agent': userAgent, "X-Forwarded-For": returnIp() } }
  )
